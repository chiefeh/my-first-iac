resource "aws_instance" "web_server" {
  ...
  vpc_security_group_ids = [ aws_security_group.allow-http-https.id, aws_security_group.icmp-inbound.id, aws_security_group.all-outbound.id, aws_security_group.ssh-from-home.id ]
